...
function resolveBackendBaseUrl(): string {
    ...
    // Use the Mac's LAN IP as the safest fallback for development
    const DEFAULT_LOCAL_IP = '192.168.0.107'; 
    const fallbackHost = Platform.OS === 'android' ? '10.0.2.2' : DEFAULT_LOCAL_IP;
